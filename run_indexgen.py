...
from azurewrapper.raw_doc_queue import ProcessRawDocQueue, ExtractStructuredDocQueue
...
driver = FileCopyDriver(uploader, ProcessRawDocQueue(), ExtractStructuredDocQueue())
