...
""".strip()
    ...
    _summarize_ask = Prompt(
        ...
        content=[
            ...
            PromptCell(
                role="user",
                content="""Describe the project in this RFP. You must always list the company that you are responding to, the key deliverables, and any specific technology packages you will use.""",
            ),
        ],
        version=1,
    )
    ...
    _extract_people = Prompt(
        ...
        content=[
            ...
            PromptCell(
                role="user",
                content="""This proposal lists people who will or who might work on the contract if the bid is successful. 
...
All people who work on this contract including vendors should be listed.
    ...
    _extract_questions = Prompt(
        ...
        content=[
            ...
            PromptCell(
                role="user",
                content="""This proposal lists many questions with their answers. Extract all questions and print one question on each line.
Do not make up questions: you should only quote every question from the document. Be sure to list every question that is asked AND ANSWERED in the doc.""".strip(),
    ...
    return [_summarize_ask, _extract_people, _extract_questions]
